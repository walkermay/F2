...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--random_init", action="store_true", help="init model with random-fine weights")
        ...
        self.parser.add_argument("--seed", type=int, default=0, help="random-fine seed for initialization")
        # training parameters
